...
void show()
{
    ...
    printf("\n--------------------------------------------------------------------------------------------------------------------------------------------------------");
    printf("\n|1 | computer graphics-1            |  80 | 20   |-- |  --    |      100      |   35     |     %d   | %d     |  --      |--      |      %d    %c       |",cg,cg1,s1,p);
    printf("\n|2 | compiler construction          |  80 | 20   |-- |  --    |      100      |   35     |     %d   | %d     |  --      |--      |      %d    %c       |",cc,cc1,s2,q);
    printf("\n|3 | v.b.net                        |  80 | 20   |-- |  --    |      100      |   35     |     %d   | %d     |  --      |--      |      %d    %c       |",v,v1,s3,r);
    printf("\n|4 | software eng-2                 |  80 | 20   |-- |  --    |      100      |   35     |     %d   | %d     |  --      |--      |      %d    %c       |",se,se1,s4,s);
    printf("\n|5 | php                            |  80 | 20   |-- |  --    |      100      |   35     |     %d   | %d     |  --      |--      |      %d    %c       |",php,php1,s5,t);
    printf("\n|6 | data communication             |  80 | 20   |-- |  --    |      100      |   35     |     %d   | %d     |  --      |--      |      %d    %c       |",dcn,dcn1,s6,u);
    printf("\n------------------------------------------------------------------------------------------------------------------------------------------------------");
    printf("\n\n\t\t GRAND TOTAL      OUT OF    percentage        ");
    printf("\n\n\t\t %d               600         %2f            "   ,total,per);
    printf("\t\t\t\nGRADE");
    printf("\t\t\t\n%c",grade);
    printf("\nRESULT");
